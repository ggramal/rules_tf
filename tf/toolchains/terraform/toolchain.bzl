"""
This module contains terraform executable toolchain.
"""

load("@rules_tf//tf:utils.bzl", "get_sha256sum")

TerraformInfo = provider(
    doc = "Information about terraform executable.",
    fields = {
        "exec": "terraform executable file",
    },
)
